...
2026-09-21：オーダーカーポートの参考ギャラリー4タイプと、選択したタイプを相談文に引き継ぐ導線を追加しました。画像は提供スクリーンショットを画像編集AIで調整したものです。自社・提携先の実績かどうかが未確認のため、「施工実績」とは表示していません。
...
- 既存の住宅・カーポート画像は完成イメージです。オーダー欄の4枚も参考画像として掲載しています。実績として紹介する際は、施工主体と掲載許可を確認し、掲載可能な元写真に差し替えてください。
